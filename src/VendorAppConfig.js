...
const VendorAppConfig = {
  ...
  onboardingConfig: {
    ...
    welcomeCaption: IMLocalized('Order food from restaurants around you and track your orders in real-time.'),
    walkthroughScreens: [
      {
      ...
      },
      {
        ...
        description: IMLocalized("Hungry? Order food in just a few clicks and we'll take care of you..")
      },
      {
        icon: require("../assets/icons/calendar-grid-icon.png"),
        title: IMLocalized("Reorder and Save"),
        description: IMLocalized("Reorder in one click. Bookmark your favorite restaurants.")
      },
      {
        icon: require("../assets/icons/binoculars.png"),
        title: IMLocalized("Track Delivery"),
        description: IMLocalized("Track your food order in real-time with an interactive map.")
      },
      {
        icon: require("../assets/icons/apple.png"),
        title: IMLocalized("Seamless Payments"),
        description: IMLocalized("Pay with your credit cards, Apple Pay or Android Pay, with one click.")
      }
    ]
  },
